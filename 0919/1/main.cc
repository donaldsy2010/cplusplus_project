...
int main(int argc, const char *argv[])
{
    ...
    Record record("donald","18613512343","shengzheng");
    vec.push_back(record.getRecord());
    Record record2("absde","18613312321","shengzheng");
